...
export default class BB_AutoKickUnassigned extends BasePlugin {
  static get description() {
    return (
      'The <code>BB_AutoKickUnassigned</code> plugin will automatically kick players that are not in a squad after a ' +
