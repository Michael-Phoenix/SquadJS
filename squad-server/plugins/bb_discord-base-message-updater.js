...
export default class BB_DiscordBaseMessageUpdater extends BasePlugin {
    ...
    for (const subscribedMessage of subscribedChannelMessages) {
      ...
      try {
        ...
        if (err.code === 10008) {
          this.verbose(
            1,
            `Message (Channel ID: ${channelID}, Message ID: ${messageID}) was already deleted. Removing from automated updates...`
          );
